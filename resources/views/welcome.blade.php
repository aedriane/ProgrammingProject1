...
<link href="{{ asset('css/css.css') }}" rel="stylesheet">@desktop
<div class="container2">
	...
	<table class="table table-striped">
		<tbody>@if(count($jobs) == 0)
			...
			@elseif(count($jobs) >= 1) @foreach($jobs as $job)
			<center>
				<hr>
			...
			</center>@endforeach</tbody>@endif</table>@endif</div>@enddesktop @mobile
<div class="container">
	<div class="searchresault">
		<center>
	...
	<table class="table table-striped">
		<tbody>@if(count($jobs) == 0)
			...
			</center>@endforeach</tbody>@endif</table>@endif</div>@endmobile @endsection
