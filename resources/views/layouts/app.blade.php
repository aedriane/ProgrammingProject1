...
<body>
	<div id="app">
		<nav class="navbar navbar-default navbar-static-top navigation">
			<div class="container1">
				...
				<div class="collapse navbar-collapse" id="app-navbar-collapse">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a style="color:#fff" class="loginregister" href="{{ route('register') }}">Register</a>
						</li>@else
			...
			<center class="spf">
				<a href="{{ route('search') }}" class="pages">
					<img src={{asset( 'img/search3.png')}} style="width:72px;height:60px;margin-top:12px;">
				</a>
				<a href="{{ route('profile') }}" class="pages">
					<img src={{asset( 'img/profile3.png')}} style="width:72px;height:60px;margin-top:12px;">
				</a>
...
<body>
	<div id="app">
		<nav class="navbar navbar-default" style="padding-bottom:8px">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown"> <a class="auth" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
							...
							<ul class="dropdown-menu auth" role="menu">
								<li> <a class="new" href="{{ route('profile') }}">Profile</a>
									<a class="new" href="{{ route('logout') }}" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                            Logout
                                        </a>
									<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">{{ csrf_field() }}</form>
			...
			<center>
				<a href="{{ route('search') }}">
					<img src={{asset( 'img/search3.png')}} style="position:relative; right:75px; width:50px; height:40px;">
				</a>
				<a href="{{ route('profile') }}">
					<img src={{asset( 'img/profile3.png')}} style="position:relative; right:10px; width:50px; height:40px;">
				</a>
				<a href="{{ route('faq') }}">
