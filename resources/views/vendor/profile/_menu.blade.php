...
<div class="list-group">
    <a href="#" class="list-group-item {{ Request::is('#') ? 'active' : '' }}  profilemenu"><h3><b>{{Auth::user()->username}}</b></h3></a>
    <a href="{{ route('profile') }}" class="list-group-item {{ Request::is('profile') ? 'active' : '' }}  profilemenu">Contact Info</a>
    <a href="{{ route('profile.security') }}"
       class="list-group-item {{ Request::is('profile/security') ? 'active' : '' }} profilemenu">Security</a>
